...
class main_window(tk.Tk):
	def __init__(self):
		...
		global br_image
		bg_image = ImageTk.PhotoImage(Image.open(r"C:\Users\saisr\Desktop\Minor\Train-time-delay-prediction-using-machine-learning-master\wp5521998-indian-railway-wallpapers.jpg").resize((600,400)))
		
		bg_label = tk.Label(self, image=bg_image)
		bg_label.place(x=0, y=0, relwidth=1, relheight=1)
		self.show_page('home')
		self.title('Train delay predictor')
...
class home(tk.Frame):
	...
	def get_delay_fun(self):
		...
		x=int(avg_delays[self.response['station']][self.response['train']])+l[s]
		return x
